...
void ShadowmapCasterShader::Begin(ID3D11DeviceContext* dc, const RenderContext& rc)
{
	...
	CbScene cbScene;
	//cbScene.viewProjection = rc.shadowmapData.lightViewProjection;
...
void ShadowmapCasterShader::Draw(ID3D11DeviceContext* dc, RenderContext& rc, const Model* model)
{
...
void ShadowmapCasterShader::End(ID3D11DeviceContext* dc, const RenderContext& rc)
{
